      ...
      <div className="relative p-6">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          {eventDate && (
            ...
            >
              ...
              <span>{format(new Date(eventDate), "EEEE, MMM d • h:mm a")}</span>
            </motion.div>
          )}
        </div>
        ...
        <div className="flex items-center justify-between gap-6">
          ...
          >
            <div
              className={cn(
                "w-20 h-20 md:w-24 md:h-24 rounded-2xl flex items-center justify-center mb-3",
            ...
            <h2 className="font-bold text-lg md:text-xl">{team0.name}</h2>
            <span className="text-3xl font-bold text-outcome-yes mt-1">{percent0}%</span>
          </motion.div>
          ...
          >
            ...
            {/* Odds bar */}
            <div className="w-32 h-1.5 bg-muted/50 rounded-full overflow-hidden flex">
              <motion.div
                initial={{ width: 0 }}
          ...
          >
            ...
            <h2 className="font-bold text-lg md:text-xl">{team1.name}</h2>
            <span className="text-3xl font-bold text-outcome-no mt-1">{percent1}%</span>
          </motion.div>
        </div>
        ...
        <motion.div
          ...
          className="flex items-center justify-center gap-6 mt-6 pt-6 border-t border-border/50"
        >
