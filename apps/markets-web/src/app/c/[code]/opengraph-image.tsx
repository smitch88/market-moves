    ...
    (
      ...
      >
        ...
        >
          ...
          >
            <span style={{ color: "#FB2C36", fontSize: "14px", fontWeight: "600", textTransform: "uppercase", letterSpacing: "0.1em" }}>
              Captain
            </span>
          </div>
          ...
          {followerCount > 0 && (
            ...
            >
              <span style={{ color: "#71717a", fontSize: "18px" }}>
                {followerCount.toLocaleString()} team member{followerCount !== 1 ? "s" : ""}
              </span>
            </div>
          )}
